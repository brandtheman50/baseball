...
const PlayVisual = () => {
  ...
  return (
    <>
      {/* Header with a clickable title to navigate back to the home page */}
      {/* Using the browser back button removes embedded video before going back to previous page */}
